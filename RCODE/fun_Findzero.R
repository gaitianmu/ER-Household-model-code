Findzero <- function(pars_estimate,file_name, init_settings) {
  ...
  init_settings$days_to_fit <- 1:65
  ...
  for  (d in 1:45){
    ...
    e_saf <-  est_mat_rr[1:65,]
    e_ssf <- est_mat_rr[66:130,]
    e_laf <- est_mat_rr[131:195,]
    e_lsf <- est_mat_rr[196:260,]
  ...
  plot(ptime, Rt_mean, ylim = c(0, 5.5), xlab = "", ylab = "", type = "p", col = "white", pch = 16, xaxt="n", cex = 0.5)
  ...
  #########RH########
  plot(ptime, Rhh_mean, ylim = c(0, 2), xlab = "", ylab = "", type = "p", col = "white", pch = 16, xaxt="n", cex = 0.5)
  mtext("Date (2020)", side = 1, line  = 3, cex = 1.01)
  ...
  ############RC#########
  plot(ptime, Rcc_mean, ylim = c(0, 4), xlab = "", ylab = "", type = "p", col = "white", pch = 16, xaxt="n", cex = 0.5)
  mtext("Date (2020)", side = 1, line  = 3, cex = 1.01)
