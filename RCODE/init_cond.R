generate_init_condi <- function(
                                ...
                                Dp = 2.3,
                                De = 2.9,
                                Dq = c(16,12,9,7,6,5,5,4,2),
                                Dqs= c(16,12,9,7,6,5,5,4,2),
                                alpha = 0.55,
                                Dh = 30,
                                MS=2.5,
                                ML=5.1,
  ...
  HS0<-3
  HL0<-3
  realData_all <- read.csv("/home/gaixin/data/Covid19CasesYC.csv", row.names = 1)  
  ...
  SS0 <- 1840000
  SL0 <- 1920000
  ST0<-(RS0+HS0+ES0+PS0+IS0+AS0+AAS0)*1.5        
  LT0<-(RL0+HL0+EL0+PL0+IL0+AL0+AAL0)*4.1        
