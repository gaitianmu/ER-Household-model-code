...
source(paste0(code_root, "RCODE/five1fun_SEIRsimu_ode.R"))
source(paste0(code_root, "RCODE/five1Rfun_SEIRsimu_ode.R"))
...
source(paste0(code_root, "RCODE/type5.1fun_Findzero.R"))
...
SEIRfitting(init_sets_list, randomize_startValue = T,
            run_id = "Type5.1-ode", output_ret = T, skip_MCMC=F)
