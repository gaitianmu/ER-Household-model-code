...
source(paste0(code_root, "RCODE/sixfun_SEIRsimu_ode.R"))
source(paste0(code_root, "RCODE/sixRfun_SEIRsimu_ode.R"))
...
source(paste0(code_root, "RCODE/type6fun_Findzero.R"))
...
SEIRfitting(init_sets_list, randomize_startValue = T,
            run_id = "type6-ode", output_ret = T, skip_MCMC=F)
